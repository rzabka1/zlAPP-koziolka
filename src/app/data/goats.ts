...
export const goats: Goat[] = [
    ...
    },
    {
        ...
        points: 2,
        description: 'Kózka Marianna, zwana Szarytką, upamiętnia Zgromadzenie Sióstr Miłosierdzia św. Wincentego á Paulo. Jej imię pochodzi od siostry Marianny Kulisińskiej – pierwszej przełożonej zgromadzenia w Lublinie. Siostry przez blisko 200 lat opiekowały się chorymi, ubogimi i sierotami.\n',
        photo: mariannaImg,
        audio: silence,
    ...
    },
    {
        ...
        points: 2,
        description: 'Koziołek LuCeK nawiązuje do Lubelskiego Centrum Konferencyjnego. Przedstawia uczestnika konferencji przesiadującego na tarasie restauracji znajdującej się w budynku. Stanowi charakterystyczny element przyciągający odwiedzających z kraju i zagranicy.',
        photo: lucekImg,
        audio: silence,
    ...
    },
    {
        ...
        points: 2,
        description: 'Koziołki Janek i Jurek znajdują się przy szpitalu wojskowym.  Powstały w  upamiętnia wydarzeń z 16-17 września 1939 roku oraz bohaterów  – Jana Iglatowskiego  i Jerzego Kędzierskiego, którzy bronili miasta i zginęli w jego obronie.',
        photo: janekJurekImg,
        audio: silence,
    ...
    },
    {
        ...
        points: 2,
        description: 'Koziołek Vetek znajduje się przed siedzibą Kliniki Weterynaryjnej przy ul. Szmaragdowej. Przypomina o znaczeniu opieki nad zwierzętami oraz o tradycjach lubelskiej weterynarii.',
        photo: vetekImg,
        audio: silence,
