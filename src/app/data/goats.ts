...
export const goats: Goat[] = [
  ...
  },
  {
    ...
    hint: "Udaj się w okolice jednego z najważniejszych zabytków sakralnych w Lublinie, który wyróżnia się wysoką wieżą i widoczny jest z wielu miejsc w mieście. Znajduje się on w samym sercu Starego Miasta, przy reprezentacyjnej ulicy prowadzącej w stronę rynku. Koziołek ukrył się tuż obok tej monumentalnej budowli – wystarczy podejść bliżej murów. Udaj się w okolice jednego z najważniejszych zabytków sakralnych w Lublinie, który wyróżnia się wysoką wieżą i widoczny jest z wielu miejsc w mieście. Znajduje się on w samym sercu Starego Miasta, przy reprezentacyjnej ulicy prowadzącej w stronę rynku. Koziołek ukrył się tuż obok tej monumentalnej budowli – wystarczy podejść bliżej murów.",
    photo: kryspinImg,
    audio: silence,
