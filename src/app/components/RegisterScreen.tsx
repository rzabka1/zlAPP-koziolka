import {Box, Button, Card, CardActionArea, Paper, TextField, Typography} from "@mui/material";
...
export default function RegisterScreen({onGoToLogin, onAccessibilityClick}: Props) {
	const {login} = useAuth();
	...
	return (
		...
		>
			...
			>
				...
				<Button variant="text" onClick={onGoToLogin} sx={{color: "primary.contrastText"}}>
					Powrót do logowania
				</Button>
			</Paper>
			<Box
