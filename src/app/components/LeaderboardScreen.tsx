...
import { Box, Typography, Avatar, Tabs, Tab, List, ListItem, ListItemAvatar, ListItemText, Paper, Button, Divider, Chip } from '@mui/material';
                                        ...
                                        >
                                            ...
                                            >
                                                <Typography
                                                    ...
                                                    sx={{
                                                        fontWeight: 'bold',
                                                        color: user.rank === 1 ? '#ffa726' : user.rank === 2 ? '#bdbdbd' : user.rank === 3 ? '#a1887f' : '#81c784',
                                                    }}
                                                >
                                                    {user.rank}
                                                </Typography>
                                            ...
                                            {user.rank <= 3 && (
                                                <EmojiEvents
                                                    sx={{
                                                        color: user.rank === 1 ? '#ffa726' : user.rank === 2 ? '#bdbdbd' : '#a1887f',
                                                        fontSize: 24,
                                                    }}
                                                />
                                            )}
