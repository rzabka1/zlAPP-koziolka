import {Box, Button, Card, CardActionArea, Link, Paper, TextField, Typography,} from "@mui/material";
...
export default function LoginScreen({onGoToRegister, onAccessibilityClick,}: Props) {
	const {login} = useAuth();
